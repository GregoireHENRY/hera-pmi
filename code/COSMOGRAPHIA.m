...
p          = 11.92*3600;
day        = 86400;
timesetup  = {'2027-JUN-05 09:10:00'}; %JUN-05 02:30/35/40 03:
...
fprintf( [ ...
    '\nDistance to Didymain:\t\t\t%.2f\t\t[km]\n' ...
    'Camera FOV:\t\t\t\t\t\t%.4f\t\t[deg]\n'      ...
    'Raycast angle:\t\t\t\t\t%.4f\t\t[deg]\n'     ...
    'Didymoon phase angle:\t\t\t%.4f\t[deg]\n'      ...
    'Didymoon in fov:\t\t\t\t%s\n'              ...
    'Didymoon surface point in fov:\t%s\n'      ...
         ],d2*1e-3,instr_fov,angray,phang,string(logical(fov)),string(logical(vw)));
fprintf('\n'); cspice_kclear;