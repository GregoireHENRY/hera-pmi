...
Results can be seen in \autoref{fig:8.1}. Variations of the thermal inertia influe on the heat sensibility (pretty much as variations of the revolution period seen in \autoref{sec:7}). The higher the thermal inertia is, the less it is sensitive to heat flux and the less the temperature will vary. The impact of the distance on temperature was predicted.
