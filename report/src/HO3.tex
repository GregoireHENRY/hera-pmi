...
\begin{center}
    ...
    \captionof{figure}{Impact of the revolution period of an asteroid on its temperature surface. Every other parameters has been set as in \autoref{sec:4}. The model considers simply the \autoref{eq:2.1} and without obliquity.}
    \label{fig:7.2}
\end{center}
