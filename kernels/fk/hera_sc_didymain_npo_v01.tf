...
Frame (FK) kernel file for Hera Didymain-Nadir Power Optimized
===============================================================================

   This frames kernel overwrites the Hera spacecraft frame (HERA_SPACECRAFT)
   definition from [3] and maps it to the Hera Didymain power optimized
   frame (HERA_DIDYMAIN_NPO) defined in [4].
   ...
   MAPPED TO THE HERA_DIDYMAIN_NPO FRAME, AND ANY CK PROVIDING ORIENTATION FOR
...
-------------------------------------------------------------------------------
   ...
   ([3]) and map it to the HERA_DIDYMAIN_NPO frame defined in the Hera Frames
   Definitions kernel.
  ...
  \begindata
      ...
      TKFRAME_-999000_RELATIVE  = 'HERA_DIDYMAIN_NPO'
