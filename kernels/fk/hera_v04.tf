...
-----------------------------------------------------------------------------
   ...
   Service at ESAC:
           ...
           Marc Costa Sitja
           (+34) 91-8131-457
           marc.costa@sciops.esa.int, esa_spice@sciops.esa.int
...
-----------------------------------------------------------------------------
   ...
   Codes -- Definition Section" at the end of this file):
      ...
      Thermal InfraRed Imager for Asteroids names/IDs:
      ...
      Asteroid Binary System names/IDs:
            ...
            DIDYMOS                     2065802  (System Barycentre)
            DIDYMAIN                    -658030
            DIDYMOON                    -658031
...
-----------------------------------------------------------------------------
  ...
  Hera mission specific science frame:
   -------------------------------------------
      ...
      DIDYMAIN_FIXED            J2000                      PCK    -658030000
      DIDYMOON_FIXED            DIDYMAIN_FIXED         DYNAMIC    -658031000
...
========================================================================
   ...
   for one of the Hera mission targets: asteroid Didymain and Didymoon.

   A body-fixed frame is defined for Didymain using standard body-fixed,
   ...
   \begindata
      ...
      FRAME_DIDYMAIN_FIXED       =  -658030
      FRAME_-658030_NAME         = 'DIDYMAIN_FIXED'
      FRAME_-658030_CLASS        =  2
      FRAME_-658030_CLASS_ID     =  -658030
      FRAME_-658030_CENTER       =  -658030
      OBJECT_-658030_FRAME       = 'DIDYMAIN_FIXED'

   \begintext


   For Didymoon we use a preliminary dynamic reference frame and we assume
   that the spin is equivalent to the orbital period for Didymoon.

   \begindata

      FRAME_DIDYMOON_FIXED          = -658031
      FRAME_-658031_NAME            = 'DIDYMOON_FIXED'
      ...
      FRAME_-658031_PRI_OBSERVER    = 'DIDYMOON'
      FRAME_-658031_PRI_TARGET      = 'DIDYMAIN'
      FRAME_-658031_PRI_ABCORR      = 'NONE'
      FRAME_-658031_SEC_AXIS        = 'Y'
      FRAME_-658031_SEC_VECTOR_DEF  = 'OBSERVER_TARGET_VELOCITY'
      FRAME_-658031_SEC_OBSERVER    = 'DIDYMOON'
      FRAME_-658031_SEC_TARGET      = 'DIDYMAIN'
...
========================================================================
   ...
   InfraRed Imager for Asteroids (TIRA) frames.


TIRA Frame Tree
--------------------------------------

   The diagram below shows the TIRA frame hierarchy.
...
--------------------------------------
   ...
   The the Thermal InfraRed Imager for Asteroids frame -- HERA_TIRA --
   ...
   Nominally, the TIRA frames are co-aligned with the s/c frame:

   \begindata

      FRAME_HERA_TIRA                  = -999210
      FRAME_-999210_NAME               = 'HERA_TIRA'
...
------------------------------------------------------------------------------
  ...
  Thermal InfraRed Imager for Asteroids:
  ----------------------------------------------------------------
