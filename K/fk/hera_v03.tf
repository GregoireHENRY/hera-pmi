...
-----------------------------------------------------------------------------
  ...
  Hera mission specific science frame:
   -------------------------------------------
      ...
      DIDYMOS_FIXED             J2000                      PCK    2065803000
      DIDYMOON_FIXED            DIDYMOS_FIXED          DYNAMIC       -999000
...
-----------------------------------------------------------------------------
  ...
  hierarchy (not including science instrument frames.)
           ...
           |                            |                        |
           V                            |                        V
      "EARTH_FIXED"                     |                  "DYDIMOS_FIXED"
      -------------                     |                  ---------------
                                        |                        |
                                        |<-ck                    |<-dyanmic
                                        |                        |
                                        V                        V
                                 "HERA_SPACECRAFT"         "DIDYMOON_FIXED"
                                 -----------------         ----------------
                                        .
                                        .
                                        .
...
========================================================================
   ...
   for one of the Hera mission targets: asteroid Diydmos and Didymoon.
   ...
   \begindata
      ...
      FRAME_DIDYMOS_FIXED              =  2065803
      FRAME_2065803_NAME               = 'DIDYMOS_FIXED'
      FRAME_2065803_CLASS              =  2
      FRAME_2065803_CLASS_ID           =  2065803
      FRAME_2065803_CENTER             =  2065803
      OBJECT_2065803_FRAME             = 'DIDYMOS_FIXED'

   \begintext

   For Didymoon we use a prelminary dynamic reference frame and we assume
   that the spin is equivalent to the orbital period for Didymoon.

   \begindata

      FRAME_DIDYMOON_FIXED          = -999000
      FRAME_-999000_NAME            = 'DIDYMOON_FIXED'
      FRAME_-999000_CLASS           =  5
      FRAME_-999000_CLASS_ID        = -999000
      FRAME_-999000_CENTER          = -999
      FRAME_-999000_RELATIVE        = 'J2000'
      FRAME_-999000_DEF_STYLE       = 'PARAMETERIZED'
      FRAME_-999000_FAMILY          = 'TWO-VECTOR'
      FRAME_-999000_PRI_AXIS        = 'X'
      FRAME_-999000_PRI_VECTOR_DEF  = 'OBSERVER_TARGET_POSITION'
      FRAME_-999000_PRI_OBSERVER    = 'DIDYMOON'
      FRAME_-999000_PRI_TARGET      = 'DIDYMOS'
      FRAME_-999000_PRI_ABCORR      = 'NONE'
      FRAME_-999000_SEC_AXIS        = 'Y'
      FRAME_-999000_SEC_VECTOR_DEF  = 'OBSERVER_TARGET_VELOCITY'
      FRAME_-999000_SEC_OBSERVER    = 'DIDYMOON'
      FRAME_-999000_SEC_TARGET      = 'DIDYMOS'
      FRAME_-999000_SEC_ABCORR      = 'NONE'
      FRAME_-999000_SEC_FRAME       = 'J2000'
...
--------------------------------------
   ...
   \begindata
      ...
      TKFRAME_-667111_RELATIVE      = 'HERA_AFC-1'
      ...
      TKFRAME_-667112_RELATIVE      = 'HERA_AFC-1'
      ...
      TKFRAME_-667113_RELATIVE      = 'HERA_AFC-1'
      ...
      TKFRAME_-667114_RELATIVE      = 'HERA_AFC-1'
      ...
      TKFRAME_-667115_RELATIVE      = 'HERA_AFC-1'
      ...
      TKFRAME_-667116_RELATIVE      = 'HERA_AFC-1'
      ...
      TKFRAME_-667117_RELATIVE      = 'HERA_AFC-1'
      ...
      TKFRAME_-667118_RELATIVE      = 'HERA_AFC-1'
...
------------------------------------------------------------------------------
  ...
  ----------------------------------------------------------------
      ...
      ---------------------  -------  --------------------------
       HERA                     -667
       HERA_SPACECRAFT       -667000   HERA_SC
       DIDYMOS               2065803
      ---------------------  -------  --------------------------
